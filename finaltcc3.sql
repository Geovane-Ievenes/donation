...
--
-- Host: localhost    Database: finaltcc3
-- ------------------------------------------------------
...
INSERT INTO `tbadm` VALUES (1,'Administrador','adm@gmail.com','40bd001563085fc35165329ea1ff5c5ecbdbbeef','2021-10-10');
...
INSERT INTO `tbcadastro_ong` VALUES (1,1,'2021-10-11',1,1);
...
CREATE TABLE `tbdoacao` (
  ...
  `id_projeto_doacao` int(11) NOT NULL,
  `id_doador_doacao` int(11) NOT NULL,
  `quantia_doacao` decimal(8,2) NOT NULL,
  `data_doacao` datetime NOT NULL,
  `status` int(11) NOT NULL,
  `comprovante_doacao` varchar(37) NOT NULL,
  PRIMARY KEY (`id_doacao`),
  KEY `fk_projeto_doacao` (`id_projeto_doacao`),
  ...
  CONSTRAINT `fk_projeto_doacao` FOREIGN KEY (`id_projeto_doacao`) REFERENCES `tbprojeto` (`id_projeto`)
...
INSERT INTO `tbperfil_ong` VALUES (1,'ONG VERIFICADA','2021-10-11','Desc','11111111111111','11111111',NULL,NULL);
...
CREATE TABLE `tbprojeto` (
  ...
  `possui_logo` int(11) NOT NULL DEFAULT 1,
  `logo_projeto` varchar(38) NOT NULL,
  `meta_projeto` decimal(8,2) DEFAULT 0.00,
  `total_arrecadado` decimal(8,2) DEFAULT NULL,
...
--
-- Table structure for table `tbsolicitacao_mudanca`
--

DROP TABLE IF EXISTS `tbsolicitacao_mudanca`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbsolicitacao_mudanca` (
  `id_solicitacao_mudanca` int(11) NOT NULL AUTO_INCREMENT,
  `id_projeto_solicitacao` int(11) NOT NULL,
  ...
  `ong_solicitacao` int(11) NOT NULL,
  `projeto_solicitacao` int(11) NOT NULL,
  `imagens_novas` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`imagens_novas`)),
  `imagens_apagadas` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`imagens_apagadas`)),
  `imagens_existentes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`imagens_existentes`)),
  `status_solicitacao` int(11) NOT NULL,
  `erro_msg` varchar(90) DEFAULT NULL,
  PRIMARY KEY (`id_solicitacao_mudanca`),
  KEY `fk_ong_solicitacao_mudanca` (`ong_solicitacao`),
  KEY `fk_projeto_solicitacao_mudanca` (`projeto_solicitacao`),
  CONSTRAINT `fk_ong_solicitacao_mudanca` FOREIGN KEY (`ong_solicitacao`) REFERENCES `tbperfil_ong` (`id_perfil_ong`),
  CONSTRAINT `fk_projeto_solicitacao_mudanca` FOREIGN KEY (`projeto_solicitacao`) REFERENCES `tbprojeto` (`id_projeto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbsolicitacao_mudanca`
--

LOCK TABLES `tbsolicitacao_mudanca` WRITE;
/*!40000 ALTER TABLE `tbsolicitacao_mudanca` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbsolicitacao_mudanca` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbtentativa_cadastro` (
  ...
  `situacao_tentativa` int(11) DEFAULT 0,
  `ext_doc_e` varchar(4) NOT NULL,
  `ext_doc_cnd` varchar(4) NOT NULL,
...
INSERT INTO `tbtentativa_cadastro` VALUES (1,1,'2021-10-11','8efb437a7ba3069863826663c1bf4828',1,'docx','docx');
...
INSERT INTO `tbusuario` VALUES (1,'Ronaldo','email','123','55935135892','2021-10-04','2004-05-17','M',0,'doador',NULL),(2,'ONG VALIDADA','ong.validada@gmail.com','40bd001563085fc35165329ea1ff5c5ecbdbbeef','55935135892','2021-10-11','2021-10-11','M',0,'ong',1);
...
-- Dump completed on 2021-11-07 21:40:45
