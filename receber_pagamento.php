<?php
	...
	if(isset($_POST['finalizar']) && isset($_SESSION['id_usuario'])){
		...
		echo('<script>alert("AVISO !! Sua doação foi efetuada com sucesso, entretanto, apenas estará disponível no menu \"Histórico de Doações\" quando o administrador enviar a comprovante de recebimento. Ademais, muito obrigado pela sua contribuição :D")</script>');
